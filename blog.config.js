...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'fukasawa', //example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，ODOOER🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HarryChang', // 
  BIO: process.env.NEXT_PUBLIC_BIO || 'HarryChang的部落格', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/ksharry/', // 网站地址
