const CONFIG = {
  ...
  NEXT_HOME_BANNER: true, // 首頁顯示大標
  NEXT_HOME_BANNER_STRINGS: ['Hi，對顧問與新科技有興趣~🎉'], // 首頁大標文字
  ...
  // 菜单
  NEXT_MENU_HOME: true, // 首页
  NEXT_MENU_CATEGORY: true, // 分類
  NEXT_MENU_TAG: true, // 標籤
  NEXT_MENU_ARCHIVE: true, // 歸檔
  NEXT_MENU_SEARCH: true, // 搜尋

  NEXT_WIDGET_TO_TOP: true, // GO TOP
  NEXT_WIDGET_TO_BOTTOM: false, // GO BOTTOM
  NEXT_WIDGET_DARK_MODE: false, // 日间/夜间模式切换
